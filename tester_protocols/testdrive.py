#opentrons protocol focused on running different functions

def get_values(*names):
    import json
    _all_values = json.loads("""{"well_plate":"biorad_96_wellplate_200ul_pcr","pipette":"p20_single_gen2","tips":"geb_96_tiprack_1000ul","pipette_mount":"left"}""")
