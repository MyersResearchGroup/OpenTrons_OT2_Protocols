...
#selfnote has not been run on OPT, but works in simulation, A1 to A1
...
metadata = {
    'protocolName': 'Thermocycler move Example Protocol',
...
#sets up the fact that the TC and plate exists
    ...
    #this is where the wells are defined 
    ...
    for t, s in zip(tc_wells, sample_wells):
        pipette.transfer(50, s, t, new_tip='never')
